...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:saxon="http://sf.net/saxon" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ifn="urn:internal:functions"
    ...
    <meta name="product" content="ArcGIS Server 10.0;ArcGIS Server for the Microsoft .NET Framework 10.0;ArcGIS Server for the Java Platform 10.0;ArcGIS Web API"/>
    <meta name="devlanguage" content="Flex (MXML/ActionScript)"/>
    <meta name="devAPI" content="Flex"/>
    <meta name="taxonomy" content="Resource Center/ArcGIS Server/Documentation/API Reference"/>
                                    <title>
                                        <xsl:if test="$isTopLevel='false'">
